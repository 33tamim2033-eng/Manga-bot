...
TOKEN = "8249827316:AAGqGmjWeLXwNaqhhcK3lbUORyMl1VXjXXc"           # 👈 توكن البوت
...
async def get_status(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("4️⃣ أرسل <b>التقييم</b> (مثل��ً: 8.5/10):", parse_mode=ParseMode.HTML)
    return RATING
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
       ...
       "<code>/request</code> - لطلب إضافة عم�� غير موجود\n\n"
...
async def show_manga_panel(update: Update, context: ContextTypes.DEFAULT_TYPE, manga_id, page=0, is_new=False, show_merged=False):
    ...
    keyboard.append([InlineKeyboardButton("↙️ الع��دة الى القائمة", callback_data="back_start")])
